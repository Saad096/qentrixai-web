...
- Name: layout.spec.ts >> /case-studies/multi-agent-ai-platform renders cleanly
...
Call log:
  - navigating to "http://127.0.0.1:3311/case-studies/multi-agent-ai-platform", waiting until "domcontentloaded"
