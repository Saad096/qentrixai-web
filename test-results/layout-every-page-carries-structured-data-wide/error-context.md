...
- Name: layout.spec.ts >> every page carries structured data
- Location: tests/e2e/layout.spec.ts:34:5
...
Call log:
  - navigating to "http://127.0.0.1:3311/privacy", waiting until "domcontentloaded"
